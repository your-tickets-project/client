  ...
  return (
    <div className="ui-modal">
      <div
        ...
        data-testid="ui-modal-overlay-element"
      >
        <div
        ...
        >
          <div className="ui-modal-icon" onClick={onCancel}>
            <XIcon />
          </div>
          ...
          {footer === undefined && (
            <div className="ui-modal-footer">
              <div className="ui-modal-default-footer">
                <div className="ui-modal-cancel-button">
                  <Button onClick={onCancel}>cancel</Button>
                </div>
                <div className="ui-modal-confirm-button">
